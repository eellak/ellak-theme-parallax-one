...
function parallax_one_scripts() {
	...
	wp_enqueue_style( 'parallax-one-style', get_stylesheet_uri(), array('parallax-one-bootstrap-style'),'1.0.0');
        ...
        /**
         * Enqueue the EELLAK changes, bromoiras david - 12/2016
         */
        wp_enqueue_style( 'eellak-parallax-one-style', get_template_directory_uri().'/css/eellak_parallax_one_style.css', 'parallax-one-style');
	...
	if ( is_front_page() ) {
                ...
                /*
                 * Enqueue the ellak script for managing window height only for the landing page.
                 */
                wp_enqueue_script( 'eellak-parallax-one-landing-js', parallax_get_file('/js/eellak_parallax_one_landing_js.js'), array('jquery'), '1.0.0', true );
